...
@JvmInline
value class Gigagray(override val value: Double) : UnitAbsorbedDose<Gigagray> {
    override fun asType(d: Double) = Gigagray(d)
    override fun asBaseUnit() = Gray(value * Consts.GIGA)
...
fun UnitAbsorbedDose<*>.toGigagray() = toUnit(Gigagray(1.0))
