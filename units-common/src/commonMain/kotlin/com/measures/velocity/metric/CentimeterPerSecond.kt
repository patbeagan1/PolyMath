...
@JvmInline
value class CentimeterPerSecond(override val value: Double) : UnitVelocity<CentimeterPerSecond> {
    override fun asType(d: Double) = CentimeterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.CENTI)
...
fun UnitVelocity<*>.toCentimeterPerSecond() = toUnit(CentimeterPerSecond(1.0))
