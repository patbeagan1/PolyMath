...
@JvmInline
value class Picopascal(override val value: Double) : UnitPressure<Picopascal> {
    override fun asType(d: Double) = Picopascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.PICO)
...
fun UnitPressure<*>.toPicopascal() = toUnit(Picopascal(1.0))
