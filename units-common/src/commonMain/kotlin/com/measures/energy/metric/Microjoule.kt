...
@JvmInline
value class Microjoule(override val value: Double) : UnitEnergy<Microjoule> {
    override fun asType(d: Double) = Microjoule(d)
    override fun asBaseUnit() = Joule(value * Consts.MICRO)
...
fun UnitEnergy<*>.toMicrojoule() = toUnit(Microjoule(1.0))
