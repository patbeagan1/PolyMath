...
@JvmInline
value class USPoint(override val value: Double) : UnitDistance<USPoint> {
    override fun asType(d: Double) = USPoint(d)
    override fun asBaseUnit() = USInch(value / 72).asBaseUnit()
...
fun UnitDistance<*>.toUSPoint() = toUnit(USPoint(1.0))
