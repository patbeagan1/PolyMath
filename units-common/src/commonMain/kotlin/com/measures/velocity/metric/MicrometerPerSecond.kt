...
@JvmInline
value class MicrometerPerSecond(override val value: Double) : UnitVelocity<MicrometerPerSecond> {
    override fun asType(d: Double) = MicrometerPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.MICRO)
...
fun UnitVelocity<*>.toMicrometerPerSecond() = toUnit(MicrometerPerSecond(1.0))
