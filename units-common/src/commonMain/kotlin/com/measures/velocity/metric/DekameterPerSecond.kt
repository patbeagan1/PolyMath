...
@JvmInline
value class DekameterPerSecond(override val value: Double) : UnitVelocity<DekameterPerSecond> {
    override fun asType(d: Double) = DekameterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.DEKA)
...
fun UnitVelocity<*>.toDekameterPerSecond() = toUnit(DekameterPerSecond(1.0))
