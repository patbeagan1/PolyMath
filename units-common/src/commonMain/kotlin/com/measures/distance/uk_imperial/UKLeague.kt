...
@JvmInline
value class UKLeague(override val value: Double) : UnitDistance<UKLeague> {
    override fun asType(d: Double) = UKLeague(d)
    override fun asBaseUnit() = UKFoot(value * 15840).asBaseUnit()
...
fun UnitDistance<*>.toUKLeague() = toUnit(UKLeague(1.0))
