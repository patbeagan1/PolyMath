...
@JvmInline
value class PicometerSquared(override val value: Double) : UnitArea<PicometerSquared> {
    override fun asType(d: Double) = PicometerSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.PICO)
...
fun UnitArea<*>.toPicometerSquared() = toUnit(PicometerSquared(1.0))
