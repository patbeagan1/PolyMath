...
@JvmInline
value class LightYear(override val value: Double) : UnitDistance<LightYear> {
    override fun asType(d: Double) = LightYear(d)
    override fun asBaseUnit() = Meter(value * 9460730472580800.0)
...
fun UnitDistance<*>.toLightYear() = toUnit(LightYear(1.0))
