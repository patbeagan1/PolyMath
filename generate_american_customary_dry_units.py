#!/usr/bin/env python3
"""
Generate individual files for American Customary dry volume units
"""
...
def parse_american_customary_dry_units():
    """Parse American Customary dry volume units from the consolidated file"""
    
    with open(BASE_DIR / "AmericanCustomaryDry.kt", 'r') as f:
        content = f.read()
...
def generate_individual_files(units, package_line, import_lines):
    ...
    # Create directory
    output_dir = BASE_DIR / "american_customary_dry"
    ...
    for unit in units:
        ...
        # Create file content
        file_content = f"""package com.measures.volume.american_customary_dry
...
def main():
    """Generate individual files for American Customary dry volume units"""
    print("Parsing American Customary dry volume units...")
    units, package_line, import_lines = parse_american_customary_dry_units()
    ...
    print("American Customary dry volume unit generation complete!")
