...
@JvmInline
value class YottameterSquared(override val value: Double) : UnitArea<YottameterSquared> {
    override fun asType(d: Double) = YottameterSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.YOTTA)
...
fun UnitArea<*>.toYottameterSquared() = toUnit(YottameterSquared(1.0))
