...
@JvmInline
value class Petapascal(override val value: Double) : UnitPressure<Petapascal> {
    override fun asType(d: Double) = Petapascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.PETA)
...
fun UnitPressure<*>.toPetapascal() = toUnit(Petapascal(1.0))
