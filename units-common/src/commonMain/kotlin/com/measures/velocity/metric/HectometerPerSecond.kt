...
@JvmInline
value class HectometerPerSecond(override val value: Double) : UnitVelocity<HectometerPerSecond> {
    override fun asType(d: Double) = HectometerPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.HECTO)
...
fun UnitVelocity<*>.toHectometerPerSecond() = toUnit(HectometerPerSecond(1.0))
