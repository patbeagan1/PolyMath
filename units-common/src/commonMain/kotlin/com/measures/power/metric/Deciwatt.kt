...
@JvmInline
value class Deciwatt(override val value: Double) : UnitPower<Deciwatt> {
    override fun asType(d: Double) = Deciwatt(d)
    override fun asBaseUnit() = Watt(value * Consts.DECI)
...
fun UnitPower<*>.toDeciwatt() = toUnit(Deciwatt(1.0))
