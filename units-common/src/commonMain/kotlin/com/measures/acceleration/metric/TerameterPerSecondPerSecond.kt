...
@JvmInline
value class TerameterPerSecondPerSecond(override val value: Double) : UnitAcceleration<TerameterPerSecondPerSecond> {
    override fun asType(d: Double) = TerameterPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toTerameterPerSecondPerSecond() = toUnit(TerameterPerSecondPerSecond(1.0))
