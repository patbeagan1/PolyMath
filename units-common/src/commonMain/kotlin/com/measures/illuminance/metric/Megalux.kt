...
@JvmInline
value class Megalux(override val value: Double) : UnitIlluminance<Megalux> {
    override fun asType(d: Double) = Megalux(d)
    override fun asBaseUnit() = Lux(value * Consts.MEGA)
...
fun UnitIlluminance<*>.toMegalux() = toUnit(Megalux(1.0))
