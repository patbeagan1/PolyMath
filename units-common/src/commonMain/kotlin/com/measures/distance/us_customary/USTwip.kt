...
@JvmInline
value class USTwip(override val value: Double) : UnitDistance<USTwip> {
    override fun asType(d: Double) = USTwip(d)
    override fun asBaseUnit() = USInch(value / 1440).asBaseUnit()
...
fun UnitDistance<*>.toUSTwip() = toUnit(USTwip(1.0))
