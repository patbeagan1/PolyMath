...
@JvmInline
value class Nanowatt(override val value: Double) : UnitPower<Nanowatt> {
    override fun asType(d: Double) = Nanowatt(d)
    override fun asBaseUnit() = Watt(value * Consts.NANO)
...
fun UnitPower<*>.toNanowatt() = toUnit(Nanowatt(1.0))
