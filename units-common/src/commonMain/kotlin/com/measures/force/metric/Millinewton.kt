...
@JvmInline
value class Millinewton(override val value: Double) : UnitForce<Millinewton> {
    override fun asType(d: Double) = Millinewton(d)
    override fun asBaseUnit() = Newton(value * Consts.MILLI)
...
fun UnitForce<*>.toMillinewton() = toUnit(Millinewton(1.0))
