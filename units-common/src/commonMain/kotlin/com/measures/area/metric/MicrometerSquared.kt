...
@JvmInline
value class MicrometerSquared(override val value: Double) : UnitArea<MicrometerSquared> {
    override fun asType(d: Double) = MicrometerSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.MICRO)
...
fun UnitArea<*>.toMicrometerSquared() = toUnit(MicrometerSquared(1.0))
