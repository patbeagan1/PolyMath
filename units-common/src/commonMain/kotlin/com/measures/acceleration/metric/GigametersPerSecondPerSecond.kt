...
@JvmInline
value class GigametersPerSecondPerSecond(override val value: Double) : UnitAcceleration<GigametersPerSecondPerSecond> {
    override fun asType(d: Double) = GigametersPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toGigametersPerSecondPerSecond() = toUnit(GigametersPerSecondPerSecond(1.0))
