...
@JvmInline
value class Yottawatt(override val value: Double) : UnitPower<Yottawatt> {
    override fun asType(d: Double) = Yottawatt(d)
    override fun asBaseUnit() = Watt(value * Consts.YOTTA)
...
fun UnitPower<*>.toYottawatt() = toUnit(Yottawatt(1.0))
