...
@JvmInline
value class YoctometerPerSecondPerSecond(override val value: Double) : UnitAcceleration<YoctometerPerSecondPerSecond> {
    override fun asType(d: Double) = YoctometerPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toYoctometerPerSecondPerSecond() = toUnit(YoctometerPerSecondPerSecond(1.0))
