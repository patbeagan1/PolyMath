...
@JvmInline
value class Dekanewton(override val value: Double) : UnitForce<Dekanewton> {
    override fun asType(d: Double) = Dekanewton(d)
    override fun asBaseUnit() = Newton(value * Consts.DEKA)
