...
@JvmInline
value class ZeptometerSquared(override val value: Double) : UnitArea<ZeptometerSquared> {
    override fun asType(d: Double) = ZeptometerSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.ZEPTO)
...
fun UnitArea<*>.toZeptometerSquared() = toUnit(ZeptometerSquared(1.0))
