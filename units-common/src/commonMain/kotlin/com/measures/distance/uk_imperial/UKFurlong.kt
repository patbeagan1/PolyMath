...
@JvmInline
value class UKFurlong(override val value: Double) : UnitDistance<UKFurlong> {
    override fun asType(d: Double) = UKFurlong(d)
    override fun asBaseUnit() = UKFoot(value * 660).asBaseUnit()
...
fun UnitDistance<*>.toUKFurlong() = toUnit(UKFurlong(1.0))
