...
@JvmInline
value class Nanogray(override val value: Double) : UnitAbsorbedDose<Nanogray> {
    override fun asType(d: Double) = Nanogray(d)
    override fun asBaseUnit() = Gray(value * Consts.NANO)
...
fun UnitAbsorbedDose<*>.toNanogray() = toUnit(Nanogray(1.0))
