...
@JvmInline
value class ZeptometersPerSecondPerSecond(override val value: Double) : UnitAcceleration<ZeptometersPerSecondPerSecond> {
    override fun asType(d: Double) = ZeptometersPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toZeptometersPerSecondPerSecond() = toUnit(ZeptometersPerSecondPerSecond(1.0))
