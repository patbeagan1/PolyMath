...
@JvmInline
value class Nanonewton(override val value: Double) : UnitForce<Nanonewton> {
    override fun asType(d: Double) = Nanonewton(d)
    override fun asBaseUnit() = Newton(value * Consts.NANO)
...
fun UnitForce<*>.toNanonewton() = toUnit(Nanonewton(1.0))
