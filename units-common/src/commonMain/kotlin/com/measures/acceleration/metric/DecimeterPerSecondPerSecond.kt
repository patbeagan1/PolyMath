...
@JvmInline
value class DecimeterPerSecondPerSecond(override val value: Double) : UnitAcceleration<DecimeterPerSecondPerSecond> {
    override fun asType(d: Double) = DecimeterPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toDecimeterPerSecondPerSecond() = toUnit(DecimeterPerSecondPerSecond(1.0))
