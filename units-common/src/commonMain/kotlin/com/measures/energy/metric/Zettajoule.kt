...
@JvmInline
value class Zettajoule(override val value: Double) : UnitEnergy<Zettajoule> {
    override fun asType(d: Double) = Zettajoule(d)
    override fun asBaseUnit() = Joule(value * Consts.ZETTA)
...
fun UnitEnergy<*>.toZettajoule() = toUnit(Zettajoule(1.0))
