...
@JvmInline
value class USSurveyMile(override val value: Double) : UnitDistance<USSurveyMile> {
    override fun asType(d: Double) = USSurveyMile(d)
    override fun asBaseUnit() = USSurveyFoot(value * 5280).asBaseUnit()
...
fun UnitDistance<*>.toUSSurveyMile() = toUnit(USSurveyMile(1.0))
