...
@JvmInline
value class USSurveyAcre1959to2022(override val value: Double) : UnitArea<USSurveyAcre1959to2022> {
    override fun asType(d: Double) = USSurveyAcre1959to2022(d)
    override fun asBaseUnit() = USSquareSurveyFoot1959to2022(value * 43560).asBaseUnit()
...
fun UnitArea<*>.toUSSurveyAcre1959to2022() = toUnit(USSurveyAcre1959to2022(1.0))
