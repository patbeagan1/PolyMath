...
@JvmInline
value class DecimeterSquared(override val value: Double) : UnitArea<DecimeterSquared> {
    override fun asType(d: Double) = DecimeterSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.DECI)
...
fun UnitArea<*>.toDecimeterSquared() = toUnit(DecimeterSquared(1.0))
