...
@JvmInline
value class USMile(override val value: Double) : UnitDistance<USMile> {
    override fun asType(d: Double) = USMile(d)
    override fun asBaseUnit() = USFoot(value * 5280).asBaseUnit()
...
fun UnitDistance<*>.toUSMile() = toUnit(USMile(1.0))
