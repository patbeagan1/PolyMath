...
@JvmInline
value class UKNauticalMile(override val value: Double) : UnitDistance<UKNauticalMile> {
    override fun asType(d: Double) = UKNauticalMile(d)
    override fun asBaseUnit() = UKFoot(value * 6076.1154855643).asBaseUnit()
...
fun UnitDistance<*>.toUKNauticalMile() = toUnit(UKNauticalMile(1.0))
