...
@JvmInline
value class YoctometerPerSecond(override val value: Double) : UnitVelocity<YoctometerPerSecond> {
    override fun asType(d: Double) = YoctometerPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.YOCTO)
...
fun UnitVelocity<*>.toYoctometerPerSecond() = toUnit(YoctometerPerSecond(1.0))
