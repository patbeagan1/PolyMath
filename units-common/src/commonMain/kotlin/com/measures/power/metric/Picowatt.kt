...
@JvmInline
value class Picowatt(override val value: Double) : UnitPower<Picowatt> {
    override fun asType(d: Double) = Picowatt(d)
    override fun asBaseUnit() = Watt(value * Consts.PICO)
...
fun UnitPower<*>.toPicowatt() = toUnit(Picowatt(1.0))
