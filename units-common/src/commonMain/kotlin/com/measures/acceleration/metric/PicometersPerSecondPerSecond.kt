...
@JvmInline
value class PicometersPerSecondPerSecond(override val value: Double) : UnitAcceleration<PicometersPerSecondPerSecond> {
    override fun asType(d: Double) = PicometersPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toPicometersPerSecondPerSecond() = toUnit(PicometersPerSecondPerSecond(1.0))
