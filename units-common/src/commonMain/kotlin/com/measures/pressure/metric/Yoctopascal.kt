...
@JvmInline
value class Yoctopascal(override val value: Double) : UnitPressure<Yoctopascal> {
    override fun asType(d: Double) = Yoctopascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.YOCTO)
...
fun UnitPressure<*>.toYoctopascal() = toUnit(Yoctopascal(1.0))
