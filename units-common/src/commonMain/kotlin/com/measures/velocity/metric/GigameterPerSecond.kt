...
@JvmInline
value class GigameterPerSecond(override val value: Double) : UnitVelocity<GigameterPerSecond> {
    override fun asType(d: Double) = GigameterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.GIGA)
...
fun UnitVelocity<*>.toGigameterPerSecond() = toUnit(GigameterPerSecond(1.0))
