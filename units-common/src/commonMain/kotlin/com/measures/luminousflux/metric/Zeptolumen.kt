...
@JvmInline
value class Zeptolumen(override val value: Double) : UnitLuminousFlux<Zeptolumen> {
    override fun asType(d: Double) = Zeptolumen(d)
    override fun asBaseUnit() = Lumen(value * Consts.ZEPTO)
...
fun UnitLuminousFlux<*>.toZeptolumen() = toUnit(Zeptolumen(1.0))
