...
@JvmInline
value class Hectopascal(override val value: Double) : UnitPressure<Hectopascal> {
    override fun asType(d: Double) = Hectopascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.HECTO)
...
fun UnitPressure<*>.toHectopascal() = toUnit(Hectopascal(1.0))
