...
@JvmInline
value class Dekawatt(override val value: Double) : UnitPower<Dekawatt> {
    override fun asType(d: Double) = Dekawatt(d)
    override fun asBaseUnit() = Watt(value * Consts.DEKA)
...
fun UnitPower<*>.toDekawatt() = toUnit(Dekawatt(1.0))
