...
@JvmInline
value class ExameterSquared(override val value: Double) : UnitArea<ExameterSquared> {
    override fun asType(d: Double) = ExameterSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.EXA)
...
fun UnitArea<*>.toExameterSquared() = toUnit(ExameterSquared(1.0))
