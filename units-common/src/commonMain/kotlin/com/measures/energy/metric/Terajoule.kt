...
@JvmInline
value class Terajoule(override val value: Double) : UnitEnergy<Terajoule> {
    override fun asType(d: Double) = Terajoule(d)
    override fun asBaseUnit() = Joule(value * Consts.TERA)
...
fun UnitEnergy<*>.toTerajoule() = toUnit(Terajoule(1.0))
