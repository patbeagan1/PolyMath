...
@JvmInline
value class ExameterPerSecond(override val value: Double) : UnitVelocity<ExameterPerSecond> {
    override fun asType(d: Double) = ExameterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.EXA)
...
fun UnitVelocity<*>.toExameterPerSecond() = toUnit(ExameterPerSecond(1.0))
