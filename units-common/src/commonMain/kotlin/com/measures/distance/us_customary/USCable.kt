...
@JvmInline
value class USCable(override val value: Double) : UnitDistance<USCable> {
    override fun asType(d: Double) = USCable(d)
    override fun asBaseUnit() = USFathom(value * 120).asBaseUnit()
...
fun UnitDistance<*>.toUSCable() = toUnit(USCable(1.0))
