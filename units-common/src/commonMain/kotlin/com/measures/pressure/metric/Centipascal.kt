...
@JvmInline
value class Centipascal(override val value: Double) : UnitPressure<Centipascal> {
    override fun asType(d: Double) = Centipascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.CENTI)
...
fun UnitPressure<*>.toCentipascal() = toUnit(Centipascal(1.0))
