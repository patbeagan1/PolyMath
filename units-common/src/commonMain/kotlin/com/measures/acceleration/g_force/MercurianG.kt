...
@JvmInline
value class MercurianG(override val value: Double) : UnitAcceleration<MercurianG> {
    override fun asType(d: Double) = MercurianG(d)
    override fun asBaseUnit() = MetersPerSecondPerSecond(value * 3.7)
...
fun UnitAcceleration<*>.toMercurianG() = toUnit(MercurianG(1.0))
