...
@JvmInline
value class Hectobecquerel(override val value: Double) : UnitActivity<Hectobecquerel> {
    override fun asType(d: Double) = Hectobecquerel(d)
    override fun asBaseUnit() = Becquerel(value * Consts.HECTO)
...
fun UnitActivity<*>.toHectobecquerel() = toUnit(Hectobecquerel(1.0))
