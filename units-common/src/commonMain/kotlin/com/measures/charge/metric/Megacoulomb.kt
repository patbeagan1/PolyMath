...
@JvmInline
value class Megacoulomb(override val value: Double) : UnitCharge<Megacoulomb> {
    override fun asType(d: Double) = Megacoulomb(d)
    override fun asBaseUnit() = Coulomb(value * Consts.MEGA)
...
fun UnitCharge<*>.toMegacoulomb() = toUnit(Megacoulomb(1.0))
