...
@JvmInline
value class Hectonewton(override val value: Double) : UnitForce<Hectonewton> {
    override fun asType(d: Double) = Hectonewton(d)
    override fun asBaseUnit() = Newton(value * Consts.HECTO)
...
fun UnitForce<*>.toHectonewton() = toUnit(Hectonewton(1.0))
