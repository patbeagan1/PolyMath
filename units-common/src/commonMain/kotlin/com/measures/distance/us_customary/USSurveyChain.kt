...
@JvmInline
value class USSurveyChain(override val value: Double) : UnitDistance<USSurveyChain> {
    override fun asType(d: Double) = USSurveyChain(d)
    override fun asBaseUnit() = USSurveyFoot(value * 66).asBaseUnit()
...
fun UnitDistance<*>.toUSSurveyChain() = toUnit(USSurveyChain(1.0))
