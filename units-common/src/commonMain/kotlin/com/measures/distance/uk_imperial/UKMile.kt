...
@JvmInline
value class UKMile(override val value: Double) : UnitDistance<UKMile> {
    override fun asType(d: Double) = UKMile(d)
    override fun asBaseUnit() = UKFoot(value * 5280).asBaseUnit()
...
fun UnitDistance<*>.toUKMile() = toUnit(UKMile(1.0))
