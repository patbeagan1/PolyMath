...
@JvmInline
value class Femtowatt(override val value: Double) : UnitPower<Femtowatt> {
    override fun asType(d: Double) = Femtowatt(d)
    override fun asBaseUnit() = Watt(value * Consts.FEMTO)
...
fun UnitPower<*>.toFemtowatt() = toUnit(Femtowatt(1.0))
