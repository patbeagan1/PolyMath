...
@JvmInline
value class UKRod(override val value: Double) : UnitDistance<UKRod> {
    override fun asType(d: Double) = UKRod(d)
    override fun asBaseUnit() = UKFoot(value * (66/4)).asBaseUnit()
...
fun UnitDistance<*>.toUKRod() = toUnit(UKRod(1.0))
