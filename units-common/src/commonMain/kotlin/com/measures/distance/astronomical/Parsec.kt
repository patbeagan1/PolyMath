...
@JvmInline
value class Parsec(override val value: Double) : UnitDistance<Parsec> {
    override fun asType(d: Double) = Parsec(d)
    override fun asBaseUnit() = Meter(value * 30856775814913673.0)
...
fun UnitDistance<*>.toParsec() = toUnit(Parsec(1.0))
