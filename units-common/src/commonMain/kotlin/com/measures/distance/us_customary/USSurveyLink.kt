...
@JvmInline
value class USSurveyLink(override val value: Double) : UnitDistance<USSurveyLink> {
    override fun asType(d: Double) = USSurveyLink(d)
    override fun asBaseUnit() = USSurveyFoot(value * 0.66).asBaseUnit()
...
fun UnitDistance<*>.toUSSurveyLink() = toUnit(USSurveyLink(1.0))
