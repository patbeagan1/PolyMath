...
@JvmInline
value class MartianYear(override val value: Double) : UnitTime<MartianYear> {
    override fun asType(d: Double) = MartianYear(d)
    override fun asBaseUnit() = Second(value * 59355072.0)
...
fun UnitTime<*>.toMartianYear() = toUnit(MartianYear(1.0))
