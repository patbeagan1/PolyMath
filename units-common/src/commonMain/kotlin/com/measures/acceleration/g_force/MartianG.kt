...
@JvmInline
value class MartianG(override val value: Double) : UnitAcceleration<MartianG> {
    override fun asType(d: Double) = MartianG(d)
    override fun asBaseUnit() = MetersPerSecondPerSecond(value * 3.72076)
...
fun UnitAcceleration<*>.toMartianG() = toUnit(MartianG(1.0))
