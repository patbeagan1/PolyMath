...
@JvmInline
value class UKThou(override val value: Double) : UnitDistance<UKThou> {
    override fun asType(d: Double) = UKThou(d)
    override fun asBaseUnit() = UKFoot(value / 12000).asBaseUnit()
...
fun UnitDistance<*>.toUKThou() = toUnit(UKThou(1.0))
