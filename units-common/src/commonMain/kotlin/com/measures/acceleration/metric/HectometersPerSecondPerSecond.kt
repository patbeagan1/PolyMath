...
@JvmInline
value class HectometersPerSecondPerSecond(override val value: Double) : UnitAcceleration<HectometersPerSecondPerSecond> {
    override fun asType(d: Double) = HectometersPerSecondPerSecond(d)
    override fun asBaseUnit() = MetersPerSecondPerSecond(value * Consts.HECTO)
...
fun UnitAcceleration<*>.toHectometersPerSecondPerSecond() = toUnit(HectometersPerSecondPerSecond(1.0))
