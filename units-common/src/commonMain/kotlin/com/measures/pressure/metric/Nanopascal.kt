...
@JvmInline
value class Nanopascal(override val value: Double) : UnitPressure<Nanopascal> {
    override fun asType(d: Double) = Nanopascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.NANO)
...
fun UnitPressure<*>.toNanopascal() = toUnit(Nanopascal(1.0))
