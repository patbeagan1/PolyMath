#!/usr/bin/env python3
"""
Base class for acceleration unit generators.
"""
...
class BaseAccelerationGenerator(ABC):
    """Base class for acceleration unit generators."""
    
    def __init__(self, subdirectory: str, package_name: str):
        """
        Initialize the base acceleration generator.
        
        Args:
            subdirectory: The subdirectory within acceleration/ (e.g., "metric", "customary")
            package_name: The Kotlin package name (e.g., "com.measures.acceleration.metric")
        """
        self.subdirectory = subdirectory
        self.package_name = package_name
        self.base_dir = get_measures_base() / "acceleration" / subdirectory
    ...
    def get_template(self) -> str:
        """
        Get the Kotlin template for acceleration units.
...
"""
    ...
    def generate(self) -> int:
        """
        Generate the acceleration units.
