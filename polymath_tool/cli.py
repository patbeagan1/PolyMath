...
GENERATION_MAP: Dict[str, List[Callable[[], int]]] = {
    ...
    "g-force-acceleration": [generators.generate_g_force_acceleration],
    "non-si-acceleration": [generators.generate_non_si_acceleration],
    "uk-imp-distance": [generators.generate_uk_imp_distance],
    "us-international-1959-distance": [generators.generate_us_international_1959_distance],
    "us-survey-1959-distance": [generators.generate_us_survey_1959_distance],
    "uk-imp-volume": [generators.generate_uk_imp_volume],
    "us-international-dry-1959-volume": [generators.generate_us_international_dry_1959_volume],
    "us-international-fluid-1959-volume": [generators.generate_us_international_fluid_1959_volume],
    "us-international-1959-area": [generators.generate_us_international_1959_area],
    "us-survey-1959-area": [generators.generate_us_survey_1959_area],
    "non-si-charge": [generators.generate_non_si_charge],
    "international-area": [generators.generate_international_area],
    "non-si-energy": [generators.generate_non_si_energy],
    "non-si-force": [generators.generate_non_si_force],
    "non-si-pressure": [generators.generate_non_si_pressure],
    "non-si-distance": [generators.generate_non_si_distance],
    "non-si-volume": [generators.generate_non_si_volume],
    "non-si-power": [generators.generate_non_si_power],
    "non-si-time": [generators.generate_non_si_time],
    "astronomical-distance": [generators.generate_astronomical_distance],
    "non-si-volume-system": [generators.generate_non_si_volume_system],
    "non-si-weight": [generators.generate_non_si_weight],
    "international-1959-distance": [generators.generate_international_1959_distance],
    "international-1959-area": [generators.generate_international_1959_area],
    ...
    "uk-imperial-1824-area": [generators.generate_uk_imperial_1824_area],
    "uk-imperial-1824-volume": [generators.generate_uk_imperial_1824_volume],
    "us-customary-1832-distance": [generators.generate_us_customary_1832_distance],
    "us-customary-1832-area": [generators.generate_us_customary_1832_area],
    "us-customary-1832-volume": [generators.generate_us_customary_1832_volume],
    "us-survey-1893-distance": [generators.generate_us_survey_1893_distance],
    "us-survey-1893-area": [generators.generate_us_survey_1893_area],
    "us-survey-1893-volume": [generators.generate_us_survey_1893_volume],
    "astronomical-distance": [generators.generate_astronomical_distance],
    "astronomical-area": [generators.generate_astronomical_area],
    "astronomical-volume": [generators.generate_astronomical_volume],
    "other-distance": [generators.generate_other_distance],
    "other-area": [generators.generate_other_area],
    "other-volume": [generators.generate_other_volume],
