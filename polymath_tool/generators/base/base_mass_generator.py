#!/usr/bin/env python3
"""
Base class for weight unit generators.
"""
...
class BaseMassGenerator(ABC):
    """Base class for weight unit generators."""
    
    def __init__(self, subdirectory: str, package_name: str):
        """
        Initialize the base weight generator.
        
        Args:
            subdirectory: The subdirectory within weight/ (e.g., "metric", "avoirdupois")
            package_name: The Kotlin package name (e.g., "com.measures.weight.metric")
        """
        self.subdirectory = subdirectory
        self.package_name = package_name
        self.base_dir = get_measures_base() / "mass" / subdirectory
    ...
    def get_template(self) -> str:
        """
        Get the Kotlin template for weight units.
