...
@JvmInline
value class MegameterPerSecond(override val value: Double) : UnitVelocity<MegameterPerSecond> {
    override fun asType(d: Double) = MegameterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.MEGA)
...
fun UnitVelocity<*>.toMegameterPerSecond() = toUnit(MegameterPerSecond(1.0))
