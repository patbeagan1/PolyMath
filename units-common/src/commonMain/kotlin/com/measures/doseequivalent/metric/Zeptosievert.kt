...
@JvmInline
value class Zeptosievert(override val value: Double) : UnitDoseEquivalent<Zeptosievert> {
    override fun asType(d: Double) = Zeptosievert(d)
    override fun asBaseUnit() = Sievert(value * Consts.ZEPTO)
...
fun UnitDoseEquivalent<*>.toZeptosievert() = toUnit(Zeptosievert(1.0))
