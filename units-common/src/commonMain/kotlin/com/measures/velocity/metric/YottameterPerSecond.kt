...
@JvmInline
value class YottameterPerSecond(override val value: Double) : UnitVelocity<YottameterPerSecond> {
    override fun asType(d: Double) = YottameterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.YOTTA)
...
fun UnitVelocity<*>.toYottameterPerSecond() = toUnit(YottameterPerSecond(1.0))
