...
@JvmInline
value class DekameterPerSecondPerSecond(override val value: Double) : UnitAcceleration<DekameterPerSecondPerSecond> {
    override fun asType(d: Double) = DekameterPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toDekameterPerSecondPerSecond() = toUnit(DekameterPerSecondPerSecond(1.0))
