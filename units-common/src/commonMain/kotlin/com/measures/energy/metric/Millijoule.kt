...
@JvmInline
value class Millijoule(override val value: Double) : UnitEnergy<Millijoule> {
    override fun asType(d: Double) = Millijoule(d)
    override fun asBaseUnit() = Joule(value * Consts.MILLI)
...
fun UnitEnergy<*>.toMillijoule() = toUnit(Millijoule(1.0))
