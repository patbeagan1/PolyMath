...
@JvmInline
value class TerameterSquared(override val value: Double) : UnitArea<TerameterSquared> {
    override fun asType(d: Double) = TerameterSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.TERA)
...
fun UnitArea<*>.toTerameterSquared() = toUnit(TerameterSquared(1.0))
