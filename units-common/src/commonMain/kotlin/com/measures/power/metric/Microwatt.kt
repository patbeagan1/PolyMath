...
@JvmInline
value class Microwatt(override val value: Double) : UnitPower<Microwatt> {
    override fun asType(d: Double) = Microwatt(d)
    override fun asBaseUnit() = Watt(value * Consts.MICRO)
...
fun UnitPower<*>.toMicrowatt() = toUnit(Microwatt(1.0))
