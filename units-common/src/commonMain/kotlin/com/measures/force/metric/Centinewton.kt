...
@JvmInline
value class Centinewton(override val value: Double) : UnitForce<Centinewton> {
    override fun asType(d: Double) = Centinewton(d)
    override fun asBaseUnit() = Newton(value * Consts.CENTI)
...
fun UnitForce<*>.toCentinewton() = toUnit(Centinewton(1.0))
