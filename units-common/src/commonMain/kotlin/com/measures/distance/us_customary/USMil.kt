...
@JvmInline
value class USMil(override val value: Double) : UnitDistance<USMil> {
    override fun asType(d: Double) = USMil(d)
    override fun asBaseUnit() = USFoot(value / 1000).asBaseUnit()
...
fun UnitDistance<*>.toUSMil() = toUnit(USMil(1.0))
