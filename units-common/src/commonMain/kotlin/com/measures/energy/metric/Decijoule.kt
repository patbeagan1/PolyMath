...
@JvmInline
value class Decijoule(override val value: Double) : UnitEnergy<Decijoule> {
    override fun asType(d: Double) = Decijoule(d)
    override fun asBaseUnit() = Joule(value * Consts.DECI)
...
fun UnitEnergy<*>.toDecijoule() = toUnit(Decijoule(1.0))
