...
@JvmInline
value class Zettanewton(override val value: Double) : UnitForce<Zettanewton> {
    override fun asType(d: Double) = Zettanewton(d)
    override fun asBaseUnit() = Newton(value * Consts.ZETTA)
...
fun UnitForce<*>.toZettanewton() = toUnit(Zettanewton(1.0))
