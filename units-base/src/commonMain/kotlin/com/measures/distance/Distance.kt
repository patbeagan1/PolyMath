...
interface UnitDistance<T : DoubleBase> : UnitType<T, Meter> {
    ...
    operator fun times(other: UnitArea<*>): Liters
    ...
    companion object {
        ...
        fun timesUnit(distance: UnitDistance<*>, other: UnitArea<*>): Liters =
            Liters(distance.asBaseUnit().value * other.asBaseUnit().value * 1000)
