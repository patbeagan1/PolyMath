...
@JvmInline
value class USLeague(override val value: Double) : UnitDistance<USLeague> {
    override fun asType(d: Double) = USLeague(d)
    override fun asBaseUnit() = USFoot(value * 15840).asBaseUnit()
...
fun UnitDistance<*>.toUSLeague() = toUnit(USLeague(1.0))
