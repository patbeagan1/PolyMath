...
@JvmInline
value class ZettameterSquared(override val value: Double) : UnitArea<ZettameterSquared> {
    override fun asType(d: Double) = ZettameterSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.ZETTA)
...
fun UnitArea<*>.toZettameterSquared() = toUnit(ZettameterSquared(1.0))
