...
@JvmInline
value class USNauticalMile(override val value: Double) : UnitDistance<USNauticalMile> {
    override fun asType(d: Double) = USNauticalMile(d)
    override fun asBaseUnit() = USCable(value * 8.43904926).asBaseUnit()
...
fun UnitDistance<*>.toUSNauticalMile() = toUnit(USNauticalMile(1.0))
