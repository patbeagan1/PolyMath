...
@JvmInline
value class Dekasecond(override val value: Double) : UnitTime<Dekasecond> {
    override fun asType(d: Double) = Dekasecond(d)
    override fun asBaseUnit() = Second(value * Consts.DEKA)
...
fun UnitTime<*>.toDekasecond() = toUnit(Dekasecond(1.0))
