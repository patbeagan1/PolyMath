...
@JvmInline
value class Petanewton(override val value: Double) : UnitForce<Petanewton> {
    override fun asType(d: Double) = Petanewton(d)
    override fun asBaseUnit() = Newton(value * Consts.PETA)
...
fun UnitForce<*>.toPetanewton() = toUnit(Petanewton(1.0))
