#!/usr/bin/env python3
"""
Base class for power unit generators.
"""
...
class BasePowerGenerator(ABC):
    """Base class for power unit generators."""
    
    def __init__(self, subdirectory: str, package_name: str):
        """
        Initialize the base power generator.
        
        Args:
            subdirectory: The subdirectory within power/ (e.g., "metric", "customary")
            package_name: The Kotlin package name (e.g., "com.measures.power.metric")
        """
        self.subdirectory = subdirectory
        self.package_name = package_name
        self.base_dir = get_measures_base() / "power" / subdirectory
    ...
    def get_template(self) -> str:
        """
        Get the Kotlin template for power units.
...
{imports_section}import com.measures.power.Watt
