#!/usr/bin/env python3
"""
Generate individual files for English International volume units
"""
...
def parse_english_international_volume_units():
    """Parse English International volume units from the consolidated file"""
    
    with open(BASE_DIR / "EnglishInternational.kt", 'r') as f:
        content = f.read()
...
def generate_individual_files(units, package_line, import_lines):
    ...
    # Create directory
    output_dir = BASE_DIR / "english_international"
    ...
    for unit in units:
        ...
        # Create file content
        file_content = f"""package com.measures.volume.english_international
...
def main():
    """Generate individual files for English International volume units"""
    print("Parsing English International volume units...")
    units, package_line, import_lines = parse_english_international_volume_units()
    ...
    print("English International volume unit generation complete!")
