...
@JvmInline
value class Exacoulomb(override val value: Double) : UnitCharge<Exacoulomb> {
    override fun asType(d: Double) = Exacoulomb(d)
    override fun asBaseUnit() = Coulomb(value * Consts.EXA)
...
fun UnitCharge<*>.toExacoulomb() = toUnit(Exacoulomb(1.0))
