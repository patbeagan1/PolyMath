...
@JvmInline
value class Yottanewton(override val value: Double) : UnitForce<Yottanewton> {
    override fun asType(d: Double) = Yottanewton(d)
    override fun asBaseUnit() = Newton(value * Consts.YOTTA)
...
fun UnitForce<*>.toYottanewton() = toUnit(Yottanewton(1.0))
