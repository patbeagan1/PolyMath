...
@JvmInline
value class CentimetersPerSecondPerSecond(override val value: Double) : UnitAcceleration<CentimetersPerSecondPerSecond> {
    override fun asType(d: Double) = CentimetersPerSecondPerSecond(d)
    override fun asBaseUnit() = MetersPerSecondPerSecond(value * Consts.CENTI)
...
fun UnitAcceleration<*>.toCentimetersPerSecondPerSecond() = toUnit(CentimetersPerSecondPerSecond(1.0))
