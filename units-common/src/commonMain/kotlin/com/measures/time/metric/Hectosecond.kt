...
@JvmInline
value class Hectosecond(override val value: Double) : UnitTime<Hectosecond> {
    override fun asType(d: Double) = Hectosecond(d)
    override fun asBaseUnit() = Second(value * Consts.HECTO)
...
fun UnitTime<*>.toHectosecond() = toUnit(Hectosecond(1.0))
