...
@JvmInline
value class Dekacoulomb(override val value: Double) : UnitCharge<Dekacoulomb> {
    override fun asType(d: Double) = Dekacoulomb(d)
...
fun UnitCharge<*>.toDekacoulomb() = toUnit(Dekacoulomb(1.0))
