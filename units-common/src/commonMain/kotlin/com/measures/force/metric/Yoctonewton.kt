...
@JvmInline
value class Yoctonewton(override val value: Double) : UnitForce<Yoctonewton> {
    override fun asType(d: Double) = Yoctonewton(d)
    override fun asBaseUnit() = Newton(value * Consts.YOCTO)
...
fun UnitForce<*>.toYoctonewton() = toUnit(Yoctonewton(1.0))
