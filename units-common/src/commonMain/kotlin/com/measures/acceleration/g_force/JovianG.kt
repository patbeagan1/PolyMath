...
@JvmInline
value class JovianG(override val value: Double) : UnitAcceleration<JovianG> {
    override fun asType(d: Double) = JovianG(d)
    override fun asBaseUnit() = MetersPerSecondPerSecond(value * 24.79)
...
fun UnitAcceleration<*>.toJovianG() = toUnit(JovianG(1.0))
