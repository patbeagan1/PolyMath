...
@JvmInline
value class Hectojoule(override val value: Double) : UnitEnergy<Hectojoule> {
    override fun asType(d: Double) = Hectojoule(d)
    override fun asBaseUnit() = Joule(value * Consts.HECTO)
...
fun UnitEnergy<*>.toHectojoule() = toUnit(Hectojoule(1.0))
