...
class UkDistanceGenerator(BaseDistanceGenerator):
    ...
    def _get_units(self):
        ...
        return [
            ...
            ("UKUKFoot", "Foot(value).asBaseUnit()"),
            ...
            ("UKFathom", "NauticalMile(value / 1000).asBaseUnit()"),
            ("UKCable", "NauticalMile(value / 100).asBaseUnit()"),
...
class UkAreaGenerator(BaseAreaGenerator):
    ...
    def _get_units(self):
        ...
        return [
            ...
            ("UKSquareInch", "SquareUKFoot(value / 144).asBaseUnit()"),
            ("UKSquareUKFoot", "SquareMeter(value * 0.09290304)"),  # Base unit for UK area
            ("UKSquareYard", "SquareUKFoot(value * 9).asBaseUnit()"),
            ("UKSquareMile", "SquareUKFoot(value * 27878400).asBaseUnit()"),
            # Traditional UK area units
            ("UKAcre", "SquareUKFoot(value * 43560).asBaseUnit()"),  # 43,560 square feet
            ("UKRood", "SquareUKFoot(value * 10890).asBaseUnit()"),  # 1/4 acre
            ("UKPerch", "SquareUKFoot(value * 272.25).asBaseUnit()"),  # 1/160 acre
        ]
