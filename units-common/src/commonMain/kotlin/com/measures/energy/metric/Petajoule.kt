...
@JvmInline
value class Petajoule(override val value: Double) : UnitEnergy<Petajoule> {
    override fun asType(d: Double) = Petajoule(d)
    override fun asBaseUnit() = Joule(value * Consts.PETA)
...
fun UnitEnergy<*>.toPetajoule() = toUnit(Petajoule(1.0))
