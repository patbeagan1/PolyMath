...
@JvmInline
value class AttometerPerSecondPerSecond(override val value: Double) : UnitAcceleration<AttometerPerSecondPerSecond> {
    override fun asType(d: Double) = AttometerPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toAttometerPerSecondPerSecond() = toUnit(AttometerPerSecondPerSecond(1.0))
