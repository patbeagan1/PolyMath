...
@JvmInline
value class HectometerSquared(override val value: Double) : UnitArea<HectometerSquared> {
    override fun asType(d: Double) = HectometerSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.HECTO)
...
fun UnitArea<*>.toHectometerSquared() = toUnit(HectometerSquared(1.0))
