...
@JvmInline
value class Piconewton(override val value: Double) : UnitForce<Piconewton> {
    override fun asType(d: Double) = Piconewton(d)
    override fun asBaseUnit() = Newton(value * Consts.PICO)
...
fun UnitForce<*>.toPiconewton() = toUnit(Piconewton(1.0))
