...
@JvmInline
value class Micropascal(override val value: Double) : UnitPressure<Micropascal> {
    override fun asType(d: Double) = Micropascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.MICRO)
...
fun UnitPressure<*>.toMicropascal() = toUnit(Micropascal(1.0))
