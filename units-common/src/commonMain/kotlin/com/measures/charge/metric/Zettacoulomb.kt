...
@JvmInline
value class Zettacoulomb(override val value: Double) : UnitCharge<Zettacoulomb> {
    override fun asType(d: Double) = Zettacoulomb(d)
    override fun asBaseUnit() = Coulomb(value * Consts.ZETTA)
...
fun UnitCharge<*>.toZettacoulomb() = toUnit(Zettacoulomb(1.0))
