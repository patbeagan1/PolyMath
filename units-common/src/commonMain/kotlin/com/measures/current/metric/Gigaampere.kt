...
@JvmInline
value class Gigaampere(override val value: Double) : UnitCurrent<Gigaampere> {
    override fun asType(d: Double) = Gigaampere(d)
    override fun asBaseUnit() = Ampere(value * Consts.GIGA)
...
fun UnitCurrent<*>.toGigaampere() = toUnit(Gigaampere(1.0))
