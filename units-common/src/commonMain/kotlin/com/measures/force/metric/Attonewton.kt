...
@JvmInline
value class Attonewton(override val value: Double) : UnitForce<Attonewton> {
    override fun asType(d: Double) = Attonewton(d)
    override fun asBaseUnit() = Newton(value * Consts.ATTO)
...
fun UnitForce<*>.toAttonewton() = toUnit(Attonewton(1.0))
