...
@JvmInline
value class Microlux(override val value: Double) : UnitIlluminance<Microlux> {
    override fun asType(d: Double) = Microlux(d)
    override fun asBaseUnit() = Lux(value * Consts.MICRO)
...
fun UnitIlluminance<*>.toMicrolux() = toUnit(Microlux(1.0))
