...
@JvmInline
value class AttometerSquared(override val value: Double) : UnitArea<AttometerSquared> {
    override fun asType(d: Double) = AttometerSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.ATTO)
...
fun UnitArea<*>.toAttometerSquared() = toUnit(AttometerSquared(1.0))
