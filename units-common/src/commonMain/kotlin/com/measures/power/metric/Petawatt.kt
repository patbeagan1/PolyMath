...
@JvmInline
value class Petawatt(override val value: Double) : UnitPower<Petawatt> {
    override fun asType(d: Double) = Petawatt(d)
    override fun asBaseUnit() = Watt(value * Consts.PETA)
...
fun UnitPower<*>.toPetawatt() = toUnit(Petawatt(1.0))
