...
@JvmInline
value class UKInch(override val value: Double) : UnitDistance<UKInch> {
    override fun asType(d: Double) = UKInch(d)
    override fun asBaseUnit() = UKFoot(value / 12).asBaseUnit()
...
fun UnitDistance<*>.toUKInch() = toUnit(UKInch(1.0))
