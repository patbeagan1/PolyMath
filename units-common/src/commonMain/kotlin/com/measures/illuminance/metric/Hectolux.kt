...
@JvmInline
value class Hectolux(override val value: Double) : UnitIlluminance<Hectolux> {
    override fun asType(d: Double) = Hectolux(d)
    override fun asBaseUnit() = Lux(value * Consts.HECTO)
...
fun UnitIlluminance<*>.toHectolux() = toUnit(Hectolux(1.0))
