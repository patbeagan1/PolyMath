...
@JvmInline
value class Teranewton(override val value: Double) : UnitForce<Teranewton> {
    override fun asType(d: Double) = Teranewton(d)
    override fun asBaseUnit() = Newton(value * Consts.TERA)
...
fun UnitForce<*>.toTeranewton() = toUnit(Teranewton(1.0))
