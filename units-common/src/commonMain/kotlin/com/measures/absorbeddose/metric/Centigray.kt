...
@JvmInline
value class Centigray(override val value: Double) : UnitAbsorbedDose<Centigray> {
    override fun asType(d: Double) = Centigray(d)
    override fun asBaseUnit() = Gray(value * Consts.CENTI)
...
fun UnitAbsorbedDose<*>.toCentigray() = toUnit(Centigray(1.0))
