...
@JvmInline
value class Dekaampere(override val value: Double) : UnitCurrent<Dekaampere> {
    override fun asType(d: Double) = Dekaampere(d)
...
fun UnitCurrent<*>.toDekaampere() = toUnit(Dekaampere(1.0))
