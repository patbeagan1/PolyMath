...
@JvmInline
value class Femtokatal(override val value: Double) : UnitCatalyticActivity<Femtokatal> {
    override fun asType(d: Double) = Femtokatal(d)
    override fun asBaseUnit() = Katal(value * Consts.FEMTO)
...
fun UnitCatalyticActivity<*>.toFemtokatal() = toUnit(Femtokatal(1.0))
