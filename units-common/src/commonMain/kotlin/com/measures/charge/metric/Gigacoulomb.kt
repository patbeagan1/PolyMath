...
@JvmInline
value class Gigacoulomb(override val value: Double) : UnitCharge<Gigacoulomb> {
    override fun asType(d: Double) = Gigacoulomb(d)
    override fun asBaseUnit() = Coulomb(value * Consts.GIGA)
...
fun UnitCharge<*>.toGigacoulomb() = toUnit(Gigacoulomb(1.0))
