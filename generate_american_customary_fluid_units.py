#!/usr/bin/env python3
"""
Generate individual files for American Customary fluid volume units
"""
...
def parse_american_customary_fluid_units():
    """Parse American Customary fluid volume units from the consolidated file"""
    
    with open(BASE_DIR / "AmericanCustomaryFluid.kt", 'r') as f:
        content = f.read()
...
def generate_individual_files(units, package_line, import_lines):
    ...
    # Create directory
    output_dir = BASE_DIR / "american_customary_fluid"
    ...
    for unit in units:
        ...
        # Create file content
        file_content = f"""package com.measures.volume.american_customary_fluid
...
def main():
    """Generate individual files for American Customary fluid volume units"""
    print("Parsing American Customary fluid volume units...")
    units, package_line, import_lines = parse_american_customary_fluid_units()
    ...
    print("American Customary fluid volume unit generation complete!")
