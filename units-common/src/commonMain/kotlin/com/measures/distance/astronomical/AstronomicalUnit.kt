package com.measures.distance.astronomical
...
@JvmInline
value class AstronomicalUnit(override val value: Double) : UnitDistance<AstronomicalUnit> {
    override fun asType(d: Double) = AstronomicalUnit(d)
    override fun asBaseUnit() = Meter(value * 149597870700.0)
...
fun UnitDistance<*>.toAstronomicalUnit() = toUnit(AstronomicalUnit(1.0))
