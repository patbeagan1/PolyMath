...
value class Henry(override val value: Double) : UnitInductance<Henry>, BaseUnit {
    ...
    override operator fun plus(other: UnitInductance<*>) = UnitInductance.plusUnit(this, other)
    override operator fun minus(other: UnitInductance<*>) = UnitInductance.minusUnit(this, other)
