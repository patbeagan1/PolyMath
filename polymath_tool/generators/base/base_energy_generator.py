#!/usr/bin/env python3
"""
Base class for energy unit generators.
"""
...
class BaseEnergyGenerator(ABC):
    """Base class for energy unit generators."""
    
    def __init__(self, subdirectory: str, package_name: str):
        """
        Initialize the base energy generator.
        
        Args:
            subdirectory: The subdirectory within energy/ (e.g., "metric", "customary")
            package_name: The Kotlin package name (e.g., "com.measures.energy.metric")
        """
        self.subdirectory = subdirectory
        self.package_name = package_name
        self.base_dir = get_measures_base() / "energy" / subdirectory
    ...
    def get_template(self) -> str:
        """
        Get the Kotlin template for energy units.
...
{imports_section}import com.measures.energy.Joule
