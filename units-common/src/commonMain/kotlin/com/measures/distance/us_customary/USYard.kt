...
@JvmInline
value class USYard(override val value: Double) : UnitDistance<USYard> {
    override fun asType(d: Double) = USYard(d)
    override fun asBaseUnit() = USFoot(value * 3).asBaseUnit()
...
fun UnitDistance<*>.toUSYard() = toUnit(USYard(1.0))
