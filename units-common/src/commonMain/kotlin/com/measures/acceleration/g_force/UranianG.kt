...
@JvmInline
value class UranianG(override val value: Double) : UnitAcceleration<UranianG> {
    override fun asType(d: Double) = UranianG(d)
    override fun asBaseUnit() = MetersPerSecondPerSecond(value * 8.69)
...
fun UnitAcceleration<*>.toUranianG() = toUnit(UranianG(1.0))
