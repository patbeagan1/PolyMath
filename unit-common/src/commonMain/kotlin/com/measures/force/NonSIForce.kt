...
value class Dyne(override val value: Double) : UnitForce<Dyne> {
    ...
    override fun asBaseUnit() = com.measures.force.Newton(this.value * 1E-5)
...
value class PoundForce(override val value: Double) : UnitForce<PoundForce> {
    ...
    override fun asBaseUnit() = com.measures.force.Newton(this.value * 4.448222)
...
value class KilogramForce(override val value: Double) : UnitForce<KilogramForce> {
    ...
    override fun asBaseUnit() = com.measures.force.Newton(this.value * 9.80665)
