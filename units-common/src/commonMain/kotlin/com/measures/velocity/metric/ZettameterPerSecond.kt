...
@JvmInline
value class ZettameterPerSecond(override val value: Double) : UnitVelocity<ZettameterPerSecond> {
    override fun asType(d: Double) = ZettameterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.ZETTA)
...
fun UnitVelocity<*>.toZettameterPerSecond() = toUnit(ZettameterPerSecond(1.0))
