...
@JvmInline
value class UKChain(override val value: Double) : UnitDistance<UKChain> {
    override fun asType(d: Double) = UKChain(d)
    override fun asBaseUnit() = UKFoot(value * 66).asBaseUnit()
...
fun UnitDistance<*>.toUKChain() = toUnit(UKChain(1.0))
