...
@JvmInline
value class YottametersPerSecondPerSecond(override val value: Double) : UnitAcceleration<YottametersPerSecondPerSecond> {
    override fun asType(d: Double) = YottametersPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toYottametersPerSecondPerSecond() = toUnit(YottametersPerSecondPerSecond(1.0))
