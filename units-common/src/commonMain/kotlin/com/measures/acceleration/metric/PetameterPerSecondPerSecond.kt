...
@JvmInline
value class PetameterPerSecondPerSecond(override val value: Double) : UnitAcceleration<PetameterPerSecondPerSecond> {
    override fun asType(d: Double) = PetameterPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toPetameterPerSecondPerSecond() = toUnit(PetameterPerSecondPerSecond(1.0))
