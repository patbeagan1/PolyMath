...
@JvmInline
value class Yoctosievert(override val value: Double) : UnitDoseEquivalent<Yoctosievert> {
    override fun asType(d: Double) = Yoctosievert(d)
    override fun asBaseUnit() = Sievert(value * Consts.YOCTO)
...
fun UnitDoseEquivalent<*>.toYoctosievert() = toUnit(Yoctosievert(1.0))
