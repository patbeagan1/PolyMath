...
@JvmInline
value class NanometerSquared(override val value: Double) : UnitArea<NanometerSquared> {
    override fun asType(d: Double) = NanometerSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.NANO)
...
fun UnitArea<*>.toNanometerSquared() = toUnit(NanometerSquared(1.0))
