...
@JvmInline
value class MegameterSquared(override val value: Double) : UnitArea<MegameterSquared> {
    override fun asType(d: Double) = MegameterSquared(d)
    override fun asBaseUnit() = SquareMeter(value * Consts.MEGA)
...
fun UnitArea<*>.toMegameterSquared() = toUnit(MegameterSquared(1.0))
