...
@JvmInline
value class Picoampere(override val value: Double) : UnitCurrent<Picoampere> {
    override fun asType(d: Double) = Picoampere(d)
    override fun asBaseUnit() = Ampere(value * Consts.PICO)
...
fun UnitCurrent<*>.toPicoampere() = toUnit(Picoampere(1.0))
