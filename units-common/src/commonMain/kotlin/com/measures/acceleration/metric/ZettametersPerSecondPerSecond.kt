...
@JvmInline
value class ZettametersPerSecondPerSecond(override val value: Double) : UnitAcceleration<ZettametersPerSecondPerSecond> {
    override fun asType(d: Double) = ZettametersPerSecondPerSecond(d)
    override fun asBaseUnit() = MetersPerSecondPerSecond(value * Consts.ZETTA)
...
fun UnitAcceleration<*>.toZettametersPerSecondPerSecond() = toUnit(ZettametersPerSecondPerSecond(1.0))
