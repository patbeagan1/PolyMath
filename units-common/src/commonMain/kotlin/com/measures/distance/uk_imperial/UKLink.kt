...
@JvmInline
value class UKLink(override val value: Double) : UnitDistance<UKLink> {
    override fun asType(d: Double) = UKLink(d)
    override fun asBaseUnit() = UKFoot(value * (66/100)).asBaseUnit()
...
fun UnitDistance<*>.toUKLink() = toUnit(UKLink(1.0))
