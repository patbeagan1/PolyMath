...
@JvmInline
value class HectometerPerSecondPerSecond(override val value: Double) : UnitAcceleration<HectometerPerSecondPerSecond> {
    override fun asType(d: Double) = HectometerPerSecondPerSecond(d)
...
fun UnitAcceleration<*>.toHectometerPerSecondPerSecond() = toUnit(HectometerPerSecondPerSecond(1.0))
