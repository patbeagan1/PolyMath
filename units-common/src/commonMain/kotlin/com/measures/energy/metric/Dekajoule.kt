...
@JvmInline
value class Dekajoule(override val value: Double) : UnitEnergy<Dekajoule> {
    override fun asType(d: Double) = Dekajoule(d)
    override fun asBaseUnit() = Joule(value * Consts.DEKA)
...
fun UnitEnergy<*>.toDekajoule() = toUnit(Dekajoule(1.0))
