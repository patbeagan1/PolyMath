...
@JvmInline
value class MercurianYear(override val value: Double) : UnitTime<MercurianYear> {
    override fun asType(d: Double) = MercurianYear(d)
    override fun asBaseUnit() = Second(value * 7600521.6)
...
fun UnitTime<*>.toMercurianYear() = toUnit(MercurianYear(1.0))
