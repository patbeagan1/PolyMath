...
@JvmInline
value class TerameterPerSecond(override val value: Double) : UnitVelocity<TerameterPerSecond> {
    override fun asType(d: Double) = TerameterPerSecond(d)
    override fun asBaseUnit() = MetersPerSecond(value * Consts.TERA)
...
fun UnitVelocity<*>.toTerameterPerSecond() = toUnit(TerameterPerSecond(1.0))
