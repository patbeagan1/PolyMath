...
@JvmInline
value class Centicoulomb(override val value: Double) : UnitCharge<Centicoulomb> {
    override fun asType(d: Double) = Centicoulomb(d)
    override fun asBaseUnit() = Coulomb(value * Consts.CENTI)
...
fun UnitCharge<*>.toCenticoulomb() = toUnit(Centicoulomb(1.0))
