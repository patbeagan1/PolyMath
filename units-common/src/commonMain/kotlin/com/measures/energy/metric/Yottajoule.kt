...
@JvmInline
value class Yottajoule(override val value: Double) : UnitEnergy<Yottajoule> {
    override fun asType(d: Double) = Yottajoule(d)
    override fun asBaseUnit() = Joule(value * Consts.YOTTA)
...
fun UnitEnergy<*>.toYottajoule() = toUnit(Yottajoule(1.0))
