...
@JvmInline
value class Zeptowatt(override val value: Double) : UnitPower<Zeptowatt> {
    override fun asType(d: Double) = Zeptowatt(d)
    override fun asBaseUnit() = Watt(value * Consts.ZEPTO)
...
fun UnitPower<*>.toZeptowatt() = toUnit(Zeptowatt(1.0))
