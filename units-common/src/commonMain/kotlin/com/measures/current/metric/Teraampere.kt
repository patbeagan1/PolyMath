...
@JvmInline
value class Teraampere(override val value: Double) : UnitCurrent<Teraampere> {
    override fun asType(d: Double) = Teraampere(d)
    override fun asBaseUnit() = Ampere(value * Consts.TERA)
...
fun UnitCurrent<*>.toTeraampere() = toUnit(Teraampere(1.0))
