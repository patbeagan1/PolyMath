...
@JvmInline
value class Zettabecquerel(override val value: Double) : UnitActivity<Zettabecquerel> {
    override fun asType(d: Double) = Zettabecquerel(d)
    override fun asBaseUnit() = Becquerel(value * Consts.ZETTA)
...
fun UnitActivity<*>.toZettabecquerel() = toUnit(Zettabecquerel(1.0))
