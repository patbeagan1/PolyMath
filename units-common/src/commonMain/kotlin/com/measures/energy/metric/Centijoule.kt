...
@JvmInline
value class Centijoule(override val value: Double) : UnitEnergy<Centijoule> {
    override fun asType(d: Double) = Centijoule(d)
    override fun asBaseUnit() = Joule(value * Consts.CENTI)
...
fun UnitEnergy<*>.toCentijoule() = toUnit(Centijoule(1.0))
