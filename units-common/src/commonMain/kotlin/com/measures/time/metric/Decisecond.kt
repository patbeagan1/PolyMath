...
@JvmInline
value class Decisecond(override val value: Double) : UnitTime<Decisecond> {
    override fun asType(d: Double) = Decisecond(d)
    override fun asBaseUnit() = Second(value * Consts.DECI)
...
fun UnitTime<*>.toDecisecond() = toUnit(Decisecond(1.0))
