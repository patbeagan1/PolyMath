...
@JvmInline
value class Giganewton(override val value: Double) : UnitForce<Giganewton> {
    override fun asType(d: Double) = Giganewton(d)
    override fun asBaseUnit() = Newton(value * Consts.GIGA)
...
fun UnitForce<*>.toGiganewton() = toUnit(Giganewton(1.0))
