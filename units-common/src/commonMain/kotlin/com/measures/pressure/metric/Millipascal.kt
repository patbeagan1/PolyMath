...
@JvmInline
value class Millipascal(override val value: Double) : UnitPressure<Millipascal> {
    override fun asType(d: Double) = Millipascal(d)
    override fun asBaseUnit() = Pascal(value * Consts.MILLI)
...
fun UnitPressure<*>.toMillipascal() = toUnit(Millipascal(1.0))
